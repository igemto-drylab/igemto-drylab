...
if __name__ == '__main__':
    ...
    default_data_path = os.path.join(
        curr_dir, 'dataset/ec_3_1_1_seqs_cleaned.txt'
    )

    parser.add_argument('--train_path', type=str,
                        default="dataset/")
    parser.add_argument('--val_path', type=str, default=default_data_path)
    parser.add_argument('--test_path', type=str, default=default_data_path)
